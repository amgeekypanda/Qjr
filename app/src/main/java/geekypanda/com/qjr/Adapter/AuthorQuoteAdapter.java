...
/**
 * Created by Prasath on 06-May-17.
 */
public class AuthorQuoteAdapter  extends RecyclerView.Adapter<AuthorQuoteAdapter.ViewHolder> {



    FragmentActivity activity;
    ArrayList<FCategoryQuoteModel> categorymodels;
    ArrayList<FAuthorQuoteModel>authorquotemodels;
    private long mLastClickTime = 0;
    private AIE_C_URL url;



    public AuthorQuoteAdapter(SoloAuthor activity, ArrayList<FAuthorQuoteModel> authorquotemodels) {
        this.activity = activity;
        this.authorquotemodels = authorquotemodels;
    }

    @Override
    public AuthorQuoteAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Picasso.with(activity)
                .load(url.getHostname()+authorquotemodels.get(position).getBig_image())
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PermissionChecker.checkSelfPermission(activity,Manifest.permission.READ_EXTERNAL_STORAGE)
                    ...
                    // intent.putExtra(Intent.EXTRA_TEXT, authorquotemodels.get(position).getText());

                    URL urll = null;
                    try {
                        urll = new URL(url.getHostname() + authorquotemodels.get(position).getBig_image());
        ...
        holder.copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sdk_Version < android.os.Build.VERSION_CODES.HONEYCOMB) {
                    ...
                    clipboard.setText(authorquotemodels.get(position).getText());   // Assuming that you are copying the text from a TextView
                    Toast.makeText(activity.getApplicationContext(), "Copied to Clipboard!", Toast.LENGTH_SHORT).show();
                }
                else {
                    android.content.ClipboardManager clipboard = (android.content.ClipboardManager) activity.getSystemService(Context.CLIPBOARD_SERVICE);
                    android.content.ClipData clip = android.content.ClipData.newPlainText("Text Label", authorquotemodels.get(position).getText());
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String uurl = url.getHostname()+authorquotemodels.get(position).getBig_image();
