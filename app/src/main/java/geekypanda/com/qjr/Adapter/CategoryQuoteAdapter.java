 ...
 */
public class CategoryQuoteAdapter extends RecyclerView.Adapter<CategoryQuoteAdapter.ViewHolder> {
    ...
    public CategoryQuoteAdapter(Activity activity, ArrayList<FCategoryQuoteModel> categoryquotemodels) {
        this.activity = activity;
        this.categorymodels = categoryquotemodels;
    }
    ...
    @Override
    public void onBindViewHolder(final CategoryQuoteAdapter.ViewHolder holder, final int position) {

        Picasso.with(activity)
                .load(url.getHostname()+categorymodels.get(position).getBig_image())
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PermissionChecker.checkSelfPermission(activity,Manifest.permission.READ_EXTERNAL_STORAGE)
                    ...
                    // intent.putExtra(Intent.EXTRA_TEXT, categorymodels.get(position).getText());

                    URL urll = null;
                    try {
                        urll = new URL(url.getHostname()+categorymodels.get(position).getBig_image());
        ...
        holder.copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sdk_Version < android.os.Build.VERSION_CODES.HONEYCOMB) {
                    ...
                    clipboard.setText(categorymodels.get(position).getText());   // Assuming that you are copying the text from a TextView
                    Toast.makeText(activity.getApplicationContext(), "Copied to Clipboard!", Toast.LENGTH_SHORT).show();
                }
                else {
                    android.content.ClipboardManager clipboard = (android.content.ClipboardManager) activity.getSystemService(Context.CLIPBOARD_SERVICE);
                    android.content.ClipData clip = android.content.ClipData.newPlainText("Text Label", categorymodels.get(position).getText());
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String uurl = url.getHostname()+categorymodels.get(position).getBig_image();
